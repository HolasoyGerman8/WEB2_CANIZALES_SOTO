...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2026 a las 18:50:08
...
CREATE TABLE `productos` (
  ...
  `cantidad_exist` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `productos` (`id_producto`, `precio`, `nombre`, `cantidad_exist`) VALUES
(1, 100, 'Cargador Iphone', 10),
(2, 75, 'Mica Iphone', 20),
(3, 200, 'Funda Iphone', 15);
